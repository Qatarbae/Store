//package org.mix.mixer.controller.course;
//
...
//import org.mix.mixer.service.courseservice.CourseService;
...
//    ) {
//        CourseCreateModel request;
//        try {
//            request = new ObjectMapper().readValue(jsonRequest, CourseCreateModel.class);
